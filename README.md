# springboot 学习
## chapter1
- [1.springboot demo](https://github.com/MarchNineteen/springbootStudy/tree/master/chapter1)
## chapter2
- [2.SpringBoot使用SpringDataJPA完成CRUD](https://github.com/MarchNineteen/springbootStudy/tree/master/chapter2)
...
## chapter4
- [9.使用拦截器记录你的SpringBoot的请求日志](https://github.com/MarchNineteen/springbootStudy/tree/master/chapter4)
- [10.SpringBoot内置SpringMvc静态文件地址修改](https://github.com/MarchNineteen/springbootStudy/tree/master/chapter4)
- [11.使用Redis作为SpringBoot项目数据缓存](https://github.com/MarchNineteen/springbootStudy/tree/master/chapter4)
