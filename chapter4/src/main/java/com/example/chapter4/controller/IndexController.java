...
public class IndexController {
    ...
    public String valid(@Valid() DemoEntity entity, BindingResult result) {
        if(result.hasErrors()) {
    ...
    public String validator(@Validated(DemoEntity.Save.class) DemoEntity entity, BindingResult result) {
        if(result.hasErrors()) {
            StringBuffer msg = new StringBuffer();
            //获取错误字段集合
            List<FieldError> fieldErrors = result.getFieldErrors();
